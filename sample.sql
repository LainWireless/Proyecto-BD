CREATE TABLE  AGENTES
   (	
    CODIGO CHAR(6), 
	NOMBRE CHAR(40), 
	AREA_TRABAJO CHAR(35), 
	COMISION NUMBER(10,2), 
	TELEFONO CHAR(15), 
	PAIS VARCHAR2(25),
	CONSTRAINT pk_agentes PRIMARY KEY (CODIGO)
	 );
   
INSERT INTO AGENTES VALUES ('A007', 'Ramasundar', 'Bangalore', '0.15', '077-25814763', '');
INSERT INTO AGENTES VALUES ('A003', 'Alex ', 'London', '0.13', '075-12458969', '');
INSERT INTO AGENTES VALUES ('A008', 'Alford', 'New York', '0.12', '044-25874365', '');
INSERT INTO AGENTES VALUES ('A011', 'Ravi Kumar', 'Bangalore', '0.15', '077-45625874', '');
INSERT INTO AGENTES VALUES ('A010', 'Santakumar', 'Chennai', '0.14', '007-22388644', '');
INSERT INTO AGENTES VALUES ('A012', 'Lucida', 'San Jose', '0.12', '044-52981425', '');
INSERT INTO AGENTES VALUES ('A005', 'Anderson', 'Brisban', '0.13', '045-21447739', '');
INSERT INTO AGENTES VALUES ('A001', 'Subbarao', 'Bangalore', '0.14', '077-12346674', '');
INSERT INTO AGENTES VALUES ('A002', 'Mukesh', 'Mumbai', '0.11', '029-12358964', '');
INSERT INTO AGENTES VALUES ('A006', 'McDen', 'London', '0.15', '078-22255588', '');
INSERT INTO AGENTES VALUES ('A004', 'Ivan', 'Torento', '0.15', '008-22544166', '');
INSERT INTO AGENTES VALUES ('A009', 'Benjamin', 'Hampshair', '0.11', '008-22536178', '');

CREATE TABLE  CLIENTES 
   (	CODIGO VARCHAR2(6) NOT NULL PRIMARY KEY, 
	NOMBRE VARCHAR2(40) NOT NULL, 
	CIUDAD CHAR(35), 
	AREA_TRABAJO VARCHAR2(35) NOT NULL, 
	PAIS VARCHAR2(20) NOT NULL, 
	GRADO NUMBER, 
    	APERTURA_AMT NUMBER(12,2) NOT NULL, 
	RECIBO_AMT NUMBER(12,2) NOT NULL, 
	PAGO_AMT NUMBER(12,2) NOT NULL, 
	AMT_PENDIENTE NUMBER(12,2) NOT NULL, 
	TELEFONO VARCHAR2(17) NOT NULL, 
	CODIGO_AGENTE CHAR(6) NOT NULL REFERENCES AGENTS
);
